...
set WA_MIG_LOG_PATH=%WA_MIG_PATH%\logs
set JAVA_OPTS=-Xms128m -Xmx1024m

set WA_MIGRATION_RUNTIME_OPTS=-Dsys.path=%WA_SYS_PATH% -Dconf.path=%WA_CONF_PATH%  -Dlogback.configurationFile=%WA_MIG_LOG_FILE% -DMODULE_PATH=%MODULE_PATH%
