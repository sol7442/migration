...
set WA_MIGRATION_RUNTIME_OPTS=-Dsys.path=%WA_SYS_PATH% -Dconf.path=%WA_CONF_PATH%  -Dlogback.configurationFile=%WA_MIG_LOG_FILE% -Dlog.path=%WA_MIG_LOG_PATH% -Dlog.mode=%WA_MIG_LOG_MODE% -Dmig.home=%WA_MIG_PATH%
